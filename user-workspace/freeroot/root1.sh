...
ROOTFS_DIR=$(pwd)
export PATH=$PATH:~/.local/usr/bin:/usr/local/bin  # Menambahkan /usr/local/bin ke PATH
max_retries=50
timeout=1
ARCH=$(uname -m)
...
# Tambahkan export PATH agar cloudflared dapat dijalankan
export PATH=/usr/local/bin:$PATH

# Menjalankan cloudflared sebelum Proot
